...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi MatchParen term=reverse cterm=bold ctermbg=208 ctermfg=223 gui=bold guibg=#FD971F guifg=#000000
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=231 ctermfg=16 gui=NONE guibg=#F8F8F0 guifg=#000000
    CSAHi lCursor term=NONE cterm=NONE ctermbg=231 ctermfg=234 gui=NONE guibg=fg guifg=bg
    CSAHi MatchParen term=reverse cterm=bold ctermbg=223 ctermfg=208 gui=bold guibg=#FD971F guifg=#000000
